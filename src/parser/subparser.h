...
void vlessConstruct(Proxy &node, const std::string &group, const std::string &remarks, const std::string &add, const std::string &port, const std::string &id, const std::string &flow, const std::string &host,  const std::string &net, const std::string &tls, tribool scv = tribool(), tribool udp = tribool(), tribool tfo = tribool(),  tribool tls13 = tribool());
